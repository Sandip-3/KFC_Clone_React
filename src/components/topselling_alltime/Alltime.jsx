...
const items = [
  {
    id: 1,
    title: "Hot & Crispy 8pc",
    description: "8pc of signature Hot & Crispy chicken at a deal price",
    price: "1850",
    imageUrl:
      "https://assets.kfc.com.np/storage/uploads/images/product/64915881132ae.webp",
  },
  {
    id: 2,
    title: "Smokey Red 1pc",
    description:
      "1pc of colonel's signature Smoky RedSpicy, red, grilled chicken",
    price: "1249",
    imageUrl:
      "https://assets.kfc.com.np/storage/uploads/images/product/6426889511a93.webp",
  },
  {
    id: 3,
    title: "Smokey Red 2pc",
    description:
      "2pc of colonel's signature Smoky RedSpicy, red, grilled chicken",
    price: "560",
    imageUrl:
      "https://assets.kfc.com.np/storage/uploads/images/product/64268862823cf.webp",
  },
  {
    id: 4,
    title: "Hot & Crispy 4pc",
    description: "4pc of signature Hot & Crispy chicken at a deal price",
    price: "999",
    imageUrl:
      "https://assets.kfc.com.np/storage/uploads/images/product/64268dcc788a8.webp",
  },
];
          ...
          {items.map((item) => (
            <div className="cart_div group w-[400px]  border hover:border-red-600 rounded-md bg-white p-2 flex flex-col">
              ...
              <div className="price_cart px-2 flex justify-between items-center ">
                ...
                <div className="cart   w-auto h-10 flex space-x-1 mb-2  items-center p-1 text-[#E5002B] border-[1.5px] border-red-500 rounded-md  hover:bg-red-600 hover:text-white">
